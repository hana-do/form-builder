                    ...
                    <div class="row align-center">
                      <div class="small-12 medium-10 columns">
                        <fieldset class="login">
                          ...
                          <input type="hidden" id="formName" name="formName" value="formName_abbr" dbCall_param="4" dbCall="eForm_StarId_Authenticate_Mnscu_CLI"/>
                          ...
                          <input type="hidden" id="rcId" name="rcId" value="schoolCode" dbCall_param="3" dbCall="eForm_StarId_Authenticate_Mnscu_CLI"/>
                          ...
                          <input type="hidden" id="userAgent" name="userAgent" dbCall_param="7" dbCall="eForm_StarId_Authenticate_Mnscu_CLI">
                            <xsl:attribute name="value">
